  ...
  <div class="container">
    <div class="card border-0 mx-auto" style="max-width: 600px;" data-aos="zoom-in">
      <div class="card-body py-5 px-4">
        ...
        <h2 class="mb-3">Check-in Berhasil!</h2>
        <p class="lead mb-4">
          Kehadiran Anda pada rapat <strong>{{ $rapat->judul ?? 'Rapat' }}</strong> telah tercatat.<br>
          Silakan ikuti jalannya rapat sesuai agenda yang telah ditentukan.
        </p>
        <a href="{{ route('tamu.rapat.saya') }}" class="btn btn-primary btn-lg">
          <i class="fas fa-calendar-check"></i> Lihat Agenda Rapat Saya
        </a>
      </div>
    </div>
  </div>
