...
<style>
    ...
    .survey-card {
        ...
        max-width: 760px; margin: auto; transition: 0.3s ease;
    }
    .survey-card:hover { box-shadow: 0 12px 28px rgba(0,0,0,0.08); }
    .survey-title { font-size: 26px; font-weight: 700; color: #1e3a8a; text-align: center; }
    .survey-sub { text-align: center; color: #475569; margin-bottom: 25px; }
    .form-group label { font-weight: 600; color: #1e293b; margin-bottom: 5px; }
    .form-control {
        border-radius: 10px; border: 1px solid #d1d5db; padding: 12px;
        transition: 0.2s ease; background: #f8fafc;
    }
    .form-control:focus { border-color: #2563eb; box-shadow: 0 0 0 3px rgba(37,99,235,0.15); }
    .radio-option {
        padding: 10px 14px; border-radius: 10px; border: 1px solid #dce1e8;
        cursor: pointer; transition: .2s ease; margin-bottom: 8px; background: #ffffff;
    }
    .radio-option:hover { background: #f8fafc; box-shadow: 0 0 0 2px rgba(37,99,235,0.15); }
    .btn-submit {
        ...
        box-shadow: 0 4px 12px rgba(37,99,235,0.3); transition: 0.25s; width: 100%;
    }
    .btn-submit:hover { transform: translateY(-2px); box-shadow: 0 6px 18px rgba(37,99,235,0.4); }
</style>
@endpush
    ...
    @endif
        ...
        @if($survey->tipe === 'Eksternal')
          <div class="form-group mt-2">
            ...
            <input type="text" name="instansi" class="form-control" value="{{ $instansi }}" readonly>
          </div>
        @endif
